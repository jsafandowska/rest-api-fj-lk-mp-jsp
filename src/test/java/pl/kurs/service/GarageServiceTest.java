...
public class GarageServiceTest {
    ...
    void shouldAddGarage() {
        ...
        Garage dto = garageService.addGarage(command);
    ...
    void shouldFindGarage() {
        ...
        Garage dto = garageService.findGarage(garage1.getId());
        assertEquals("X", dto.getAddress());
    ...
    public void shouldAddCarToGarage() {
        ...
        Garage result = garageService.addCarToGarage(1, 1);
        assertEquals(result.getAddress(), "X");
        assertEquals(result.getPlaces(), 2);
